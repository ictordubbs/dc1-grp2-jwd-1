...
<form action="update_query.php" method="POST" enctype="multipart/from-data">
    <div class="form-group">
        <label>Titre</label>
        <input type="text" name="titre" value="<?php echo $photo["titre"]; ?>" placeholder="Titre" class="form-control">
    </div>
    <div class="form-group">
        <label>Image</label>
